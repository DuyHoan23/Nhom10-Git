...
<aside class="app-sidebar" style ="height: 100%;">
        ...
        <ul class="app-menu">
          <li><a class="app-menu__item haha" href="index.php"><i class="app-menu__icon bx fa-solid fa-cart-shopping"></i>
            ...
            <li><a class="app-menu__item active" href="qltk.php">
                 <img class="app-menu__item-img" src="icon/taikhoan.png" alt="">
                <span class="app-menu__label">Quản lý tài khoản</span></a>
          </li>
          <li><a class="app-menu__item active" href="/live/NhanVien">
                 <img class="app-menu__item-img" src="icon/nhanvien.jpg" alt="">
                <span class="app-menu__label">Quản lý nhân viên </span></a>
          </li>
          <li><a class="app-menu__item active" href="Mainsanpham.php">
          ...
          <li><a class="app-menu__item" href="qlyhoadon.php">
            <img class="app-menu__item-img" src="icon/hoadon.jpg" alt="">
                <span class="app-menu__label">Quản lý hóa đơn</span></a>
          </li>
          <li><a class="app-menu__item" href="statistical2.php">
          ...
          <li><a class="app-menu__item" href="login_admin.php">
            <!-- <img class="app-menu__item-img" src="icon/GF1.jpg" alt=""> -->
